...
COLLECT_API_KEY = os.getenv("2hzWeONjYeCpsnpk1PUPzU:0JVNmBV8pASvPE3XKoiqG7")

def get_live_data():
    auth_key = f"apikey {COLLECT_API_KEY.replace('apikey ', '')}"
    ...
    try:
        ...
        # Gümüş bazen farklı isimle gelebilir, kontrol ekledik
        try:
